...
test.describe('Inventory Logic & Smart Operations', () => {
    ...
    test('should perform smart merge when moving item to existing location', async ({ inventoryPage, movementModal }) => {
        ...
        // LOC-B should have 0 quantity (since 0-qty items are now visible)
