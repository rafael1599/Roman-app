...
export const useLocationSuggestions = (sku: string | null, targetWarehouse: string | null, excludeLocation: string | null = null) => {
    ...
    }, [targetWarehouse, ludlowData, atsData, locationCapacities, skuVelocity, allVelocities, getZone, locations]);
