    ...
    const handleManualSubmit = async () => {
        ...
        try {
            ...
            if (data) {
                ...
                const confirmed = window.confirm(`Order #${manualOrder} is currently active by ${owner}. Do you want to take it over?`);
                if (confirmed) {
                    await supabase
                        .from('picking_lists')
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-surface border border-subtle rounded-3xl w-full max-w-sm overflow-hidden shadow-2xl scale-100 animate-in zoom-in-95 duration-200">
                ...
                <div className="px-6 py-4 border-b border-subtle bg-main/50 flex items-center justify-between">
                    <div>
                        <h3 className="text-lg font-black text-content uppercase tracking-tight">Start New Picking Order</h3>
                        {pendingItem && (
                        ...
                        <>
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    <div className="font-black text-content uppercase tracking-tight">Auto-Generate ID</div>
                                    <div className="text-xs text-muted font-medium">Create a new unique order number</div>
                                </div>
                            </button>
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    <div className="font-black text-content uppercase tracking-tight">Enter Order #</div>
                            ...
                            <div className="p-3 bg-blue-500/10 border border-blue-500/20 rounded-xl flex items-start gap-3">
                                ...
                                <p className="text-xs text-blue-400 leading-relaxed font-medium">
                                    Starting a new order will clear any previous unsaved picking data to ensure accuracy.
                                </p>
                            </div>
                        </>
                    ) : (
