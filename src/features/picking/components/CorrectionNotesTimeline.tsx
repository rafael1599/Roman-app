...
interface CorrectionNotesTimelineProps {
    notes: Note[];
    isLoading: boolean;
}

export const CorrectionNotesTimeline: React.FC<CorrectionNotesTimelineProps> = ({ notes, isLoading }) => {
...
const NoteItem: React.FC<NoteItemProps> = ({ note, isLatest, isHistorical }) => (
    <div
