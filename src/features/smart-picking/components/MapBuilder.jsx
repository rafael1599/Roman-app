      ...
      <div className="flex flex-col gap-3 sm:gap-4">
        ...
        <div className="flex bg-gray-800 rounded-lg p-1 border border-green-500/30">
          <button
            ...
            className={`flex-1 px-3 sm:px-4 py-2.5 rounded-md font-semibold text-sm sm:text-base transition-all touch-manipulation ${
              warehouse === 'ludlow'
        ...
        <div className="flex flex-col sm:flex-row gap-2 sm:gap-3">
          ...
          <div className="flex gap-2 sm:gap-3">
            ...
            <button
              ...
              className={`flex-1 sm:flex-none px-4 py-3 sm:py-2 rounded-lg font-semibold transition-all text-sm sm:text-base touch-manipulation ${
                isSaving
            ...
            <div key={location} className="flex items-center gap-2">
              <span
                className={`text-sm font-mono ${
                  customLocations.includes(location) ? 'text-blue-400' : 'text-green-500'
                }`}
              >
                {index + 1}. {location}
              </span>
