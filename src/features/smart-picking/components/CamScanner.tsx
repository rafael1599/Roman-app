 ...
 */
export default function CamScanner({ onScanComplete, onCancel }: CamScannerProps) {
  ...
  const generatePDF = async (): Promise<Blob> => {
    if (photos.length === 0) throw new Error('No photos to generate PDF');
    ...
    return new Promise((resolve, reject) => {
      ...
      photos.forEach((photo, index) => {
        ...
        img.onload = () => {
          ...
          pdf.addImage(photo.dataUrl, 'JPEG', margin, currentY, imageWidth, imageHeight);
          ...
          {photos.length > 0 && (
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="text-content font-semibold">📸 Photos ({photos.length})</div>
                {!isScanning && (
                  <button
                    onClick={() => setPhotos([])}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            >
              ...
              <div className="text-center">
                ...
                <div className="text-muted text-sm mt-1">Use your device camera</div>
              </div>
            </button>
            ...
            >
              ...
              <div className="text-center">
                ...
                <div className="text-muted text-sm mt-1">Select from gallery</div>
              </div>
            </button>
          </div>
