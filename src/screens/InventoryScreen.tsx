...
export const InventoryScreen = () => {
  ...
  const handleDownloadView = useCallback(async () => {
    ...
    try {
      ...
      doc.setFontSize(24);
      doc.text('Stock View Report', 0.5, 0.6);

      doc.setFont('times', 'normal');
      doc.setFontSize(14);
      doc.text(`Generated by: ${generatorName}`, 0.5, 1.0);
      doc.text(`Date: ${todayStr}`, 0.5, 1.3);
      ...
      if (filterDesc) {
        doc.text(`Filters: ${filterDesc}`, 0.5, 1.6);
      }

      doc.text(`Total SKUs: ${filteredStats.totalSkus}`, 7.5, 1.0);
      doc.text(`Total Qty: ${filteredStats.totalQuantity}`, 7.5, 1.3);
      ...
      autoTable(doc, {
        ...
        columnStyles: {
          0: { cellWidth: 2.5, fontStyle: 'bold' },
          1: { cellWidth: 1.5 },
          2: { cellWidth: 1.5 },
          3: { cellWidth: 1.0, halign: 'right' },
          4: { cellWidth: 'auto' },
        },
