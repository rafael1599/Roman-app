        ...
        <div className="min-h-screen bg-main flex items-center justify-center p-4">
            <div className="w-full max-w-sm space-y-8">
                <div className="text-center space-y-2">
                    ...
                    <h1 className="text-3xl font-black text-content tracking-tighter">
                        Roman App
                    </h1>
                    ...
                    <div className="space-y-4">
                        <div className="relative group">
                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <Mail className="text-muted group-focus-within:text-accent transition-colors" size={20} />
                            </div>
                            <input
                                type="email"
                                value={email}
                        ...
                        <div className="relative group">
                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <KeyRound className="text-muted group-focus-within:text-accent transition-colors" size={20} />
                            </div>
                            <input
                                type="password"
                                value={password}
