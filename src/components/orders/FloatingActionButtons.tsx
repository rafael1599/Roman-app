        ...
        <>
            ...
            <div className="flex items-center gap-3 p-3 bg-card backdrop-blur-2xl border border-subtle rounded-[2.5rem] shadow-2xl">
                ...
                <button
                    ...
                    key={glowKey === 'left' ? `prev-glow-${Date.now()}` : 'prev'}
                >
                ...
                <button
                    ...
                    `}
                >
                    {isPrinting ? <Loader2 className="animate-spin w-7 h-7" /> : <Printer className="w-7 h-7" />}
                ...
                <button
                    ...
                    `}
                    title="Next Order"
                    key={glowKey === 'right' ? `next-glow-${Date.now()}` : 'next'}
                >
